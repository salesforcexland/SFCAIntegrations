...
$MAXIMUM_INLINE_COMMENTS_PER_PR = $env:INPUT_MAXIMUMINLINECOMMENTSPERPR
Write-Host "Set MAXIMUM_INLINE_COMMENTS_PER_PR to: $MAXIMUM_INLINE_COMMENTS_PER_PR"
$env:MAXIMUM_INLINE_COMMENTS_PER_PR = $MAXIMUM_INLINE_COMMENTS_PER_PR
...
$CONFIG_SUBFOLDER_PATH = $env:INPUT_CONFIGSUBFOLDERPATH
Write-Host "Set CONFIG_SUBFOLDER_PATH to: $CONFIG_SUBFOLDER_PATH"
$env:CONFIG_SUBFOLDER_PATH = $CONFIG_SUBFOLDER_PATH

$RULE_SELECTOR = $env:INPUT_RULESELECTOR
